...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_desc: "Building real apps from Turkmenistan. 600+ users. Targeting MEXT scholarship at University of Tokyo.",
            ...
            about_p2: "I build apps that solve real problems. My medicinal plants app has 600+ active users. My next project is an AR marketplace that lets people see products in real space before buying.",
            ...
            journey_h_2025: "600+ Users",
            journey_p_2025: "Medicinal plants app reached 600+ active users. Integrated AI assistant and plant recognition.",
        ...
        tk: {
            ...
            hero_desc: "Türkmenistandan hakyky programmalary gurýaryn. 600+ ulanyjy. Tokio uniwersitetinde MEXT talyp hakyny almagy maksat edinýärin.",
            ...
            about_p2: "Men hakyky meseleleri çözýän programmalary gurýaryn. Meniň dermanlyk ösümlikler programmamda 600+ işjeň ulanyjy bar. Indiki taslamam, harytlary satyn almazdan ozal hakyky giňişlikde görmäge mümkinçilik berýän AR söwda meýdançasy.",
            ...
            journey_h_2025: "600+ Ulanyjy",
            journey_p_2025: "Dermanlyk ösümlikler programmasy 600+ işjeň ulanyja ýetdi.",
        ...
        ru: {
            ...
            hero_desc: "Создаю реальные приложения из Туркменистана. 600+ пользователей. Цель — стипендия MEXT в Токийском университете.",
            ...
            about_p2: "Я создаю приложения, которые решают реальные проблемы. Мое приложение о лекарственных растениях имеет более 600 активных пользователей.",
            ...
            journey_h_2025: "600+ пользователей",
            journey_p_2025: "Приложение достигло 600+ активных пользователей. Добавлен ИИ и распознавание растений.",
        ...
        ja: {
            ...
            hero_desc: "トルクメニスタンから実用的なアプリを開発中。600人以上のユーザー。東京大学のMEXT奨学金を目指しています。",
            hero_btn_projects: "プロジェクトを見る",
            hero_btn_github: "GitHub",
            about_label: "自己紹介",
            about_title: "プロフィール",
            about_p1: "12歳の時にトルクメニスタンでプログラミングを始めました。メンターもチームもリソースもありませんでした。",
            about_p2: "実社会の課題を解決するアプリを作っています。薬用植物アプリは600人以上のユーザーがいます。",
            ...
            journey_h_2025: "ユーザー数600人突破",
            journey_p_2025: "薬用植物アプリが600人以上のユーザーを達成しました。",
            journey_h_2026: "AR開発",
    ...
    function initAIAssistant() {
        ...
        async function getAIResponse(userText) {
            ...
            His key projects: Dermanlyk (Medicinal Plants App with 600+ users), Görüm (AR Marketplace), and various work for "Gunbatar Shapagy" and "IOSPO".
